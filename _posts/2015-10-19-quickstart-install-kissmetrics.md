...
To get more of the metrics that matter to your business, you'll need to set up custom events and properties. The easiest way to get started with custom events is to use our click-to-track feature, found under the "events" section of the navigation bar. There are undoubtedly some metrics that matter more to your business than others, but generally there are a few metrics you'll want to set up right away:
