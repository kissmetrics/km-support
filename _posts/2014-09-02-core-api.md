...
{% highlight sh %}
curl --header 'Authorization: Bearer your-token-here' 'https://api.kissmetrics.com/core'
...
{% highlight sh %}
curl --header 'Authorization: Bearer your-token-here' 'https://api.kissmetrics.com/core/accounts'
{% endhighlight %}
...
{% highlight sh %}
curl --header 'Authorization: Bearer your-token-here' 'https://api.kissmetrics.com/core/accounts/51cc9c30-0edf-0131-ead3-12313b0d181e'
{% endhighlight %}
...
{% highlight sh %}
curl --header 'Authorization: Bearer your-token-here' 'https://api.kissmetrics.com/core/products'
{% endhighlight %}
...
{% highlight sh %}
curl --header 'Authorization: Bearer your-token-here' 'https://api.kissmetrics.com/core/reports'
{% endhighlight %}
...
{% highlight sh %}
curl --header 'Authorization: Bearer your-token-here' 'https://api.kissmetrics.com/core/events'
{% endhighlight %}
...
{% highlight sh %}
curl --header 'Authorization: Bearer your-token-here' 'https://api.kissmetrics.com/core/properties'
{% endhighlight %}
...
{% highlight sh %}
curl --header 'Authorization: Bearer your-token-here' 'https://api.kissmetrics.com/core/properties/6234e85e-2941-11e4-a20e-12313932e372'
{% endhighlight %}
...
{% highlight sh %}
curl 'https://api.kissmetrics.com/core/metrics'
{% endhighlight %}
...
{% highlight sh %}
curl 'https://api.kissmetrics.com/core/metrics/48434344-088b-1031-a8b0-22923a9f01ba'
{% endhighlight %}
