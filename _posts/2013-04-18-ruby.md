...
**The KISSmetrics Ruby gem is not currently thread safe.** Until we release an official thread safe gem, please visit [pazustep's threadsafe branch](https://github.com/pazustep/km/tree/threadsafe).
