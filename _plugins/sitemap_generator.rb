...
# Site: http://www.kinnetica.com | https://github.com/kinnetica/jekyll-plugins
...
module Jekyll
  ...
  MY_URL = "http://support.kissmetrics.com"
  ...
  class SitemapGenerator < Generator
    ...
    def generate(site)
      ...
      file = File.new(File.join(site.source, filename), "w") # Output to repo directory instead of /_site
